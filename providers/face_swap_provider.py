...
def _load() -> None:
    ...
    # 1. Only load if not already loaded
    if _app is not None:
        return
    ...
    print("Loading Face-Swap models into VRAM... please wait.")
    
    # Initialize FaceAnalysis
    # ctx_id=0 tells it to use the first NVIDIA GPU
    ...
    # RTX 6000 Optimization: Use CUDA instead of CPU
    # This moves the processing off your System RAM and onto your GPU
